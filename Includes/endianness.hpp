...
#define LITTLEENDIAN
	...
	defined(_M_IA64) || defined(__itanium__) || defined(i386) ||                   \
	...
	defined(__amd64) || defined(_M_X64) || defined(__bfin__) ||                    \
...
inline __m256i swap_u256(__m256i value)
{
	const __m256i shuffle =
		_mm256_set_epi64x(0x0001020304050607, 0x08090a0b0c0d0e0f, 0x0001020304050607,
						  0x08090a0b0c0d0e0f);
